...
(function() {
  var Announcement, Auth, Cryptocurrency, Device, DoNotReset, Eldest, PGPUpdate, PerUserKey, Revoke, Sibkey, Subkey, Track, Untrack, UpdatePassphraseHash, UpdateSettings, Wallet, alloc, base, get_klass, lookup_tab, team, web_service, _ref;
  ...
  DoNotReset = require('./do_not_reset').DoNotReset;
