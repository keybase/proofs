...
(function() {
  var Announcement, Auth, Cryptocurrency, Device, Eldest, PGPUpdate, PerUserKey, Revoke, Sibkey, Stellar, Subkey, Track, Untrack, UpdatePassphraseHash, UpdateSettings, alloc, base, get_klass, get_own, lookup_tab, team, team_hidden, web_service, wot, _ref;
  ...
  get_klass = function(type, extra_lookup_tab) {
    var err, klass;
    err = klass = null;
    if (!(((extra_lookup_tab != null) && ((klass = get_own(extra_lookup_tab, type)) != null)) || ((klass = get_own(lookup_tab, type)) != null))) {
