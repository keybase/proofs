...
(function() {
  var Announcement, Auth, Cryptocurrency, Device, Eldest, PGPUpdate, PerUserKey, Revoke, Sibkey, Subkey, Track, Untrack, UpdatePassphraseHash, UpdateSettings, WalletKey, alloc, base, get_klass, lookup_tab, team, web_service, _ref;
  ...
  WalletKey = require('./wallet_key').WalletKey;
