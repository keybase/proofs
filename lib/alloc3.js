...
(function() {
  var KeyManager, OuterLink, RotateKey, alloc_v3, bufeq_secure, bufferify, constants, errors, iced, make_esc, parse, pgp_utils, sha256, __iced_k, __iced_k_noop, _alloc_inner_obj, _check_chain, _check_inner, _check_prev, _hex_to_buffer, _parse_inputs, _parse_outer_link, _ref, _uid_eq, _verify_inner_hash, _verify_outer_sig;
  ...
  _parse_inputs = function(_arg) {
    var armored, check_params, e, errout, json, km, raw, skip_inner, _ref1, _ref2, _ref3, _ref4;
    ...
    if (!parse.is_uid(check_params != null ? (_ref1 = check_params.user) != null ? (_ref2 = _ref1.local) != null ? _ref2.uid : void 0 : void 0 : void 0)) {
      return errout("need a valid UID");
    }
    if (!parse.is_seqno(check_params != null ? (_ref3 = check_params.user) != null ? (_ref4 = _ref3.local) != null ? _ref4.eldest_seqno : void 0 : void 0 : void 0)) {
      return errout("need a valid eldest_seqno");
    }
    if (!parse.is_prev(check_params.prev)) {
      return errout('need a valid or null prev pointer"');
    }
    if (!parse.is_seqno(check_params != null ? check_params.seqno : void 0)) {
