...
(function() {
  ...
  exports.Auth = Auth = (function(_super) {
    ...
    Auth.prototype._optional_sections = function() {
      return Auth.__super__._optional_sections.call(this).concat(["nonce", "session", "auth"]);
    };
    ...
    Auth.prototype._json = function() {
      ...
      if (this.session != null) {
        ret.body.auth.session = this.session;
      }
      return ret;
    };
