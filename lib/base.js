...
(function() {
  ...
  hash_pgp_key = function(key) {
    return (new kbpgp.hash.SHA256(new Buffer(key.trim()))).toString("hex");
  };
        ...
        return (function(__iced_k) {
          if (_this._full_pgp_hash === void 0) {
            ...
            (function(__iced_k) {
              ...
              return __iced_k(_this._full_pgp_hash = typeof key !== "undefined" && key !== null ? hash_pgp_key(key) : null);
            });
          } else {
            return __iced_k();
          }
