...
(function() {
  ...
  Verifier = (function() {
    function Verifier(_arg, sig_eng, base) {
      this.armored = _arg.armored, this.id = _arg.id, this.short_id = _arg.short_id, this.skip_ids = _arg.skip_ids, this.make_ids = _arg.make_ids, this.strict = _arg.strict, this.now = _arg.now, this.critical_clock_skew_secs = _arg.critical_clock_skew_secs, this.skip_clock_skew_check = _arg.skip_clock_skew_check, this.inner = _arg.inner, this.outer = _arg.outer, this.expansions = _arg.expansions;
    ...
    Verifier.prototype._check_json = function(_arg, cb) {
      ...
      if (this.strict && ((ours = trim(json_stringify_sorted(this.json))) !== json_str_utf8_trimmed)) {
  ...
  Base = (function() {
    ...
    Base.prototype.generate = function(cb) {
      var armored, esc, expansions, id, inner, json, json_obj, opts, out, pgp, raw, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    Base.prototype.generate_v2 = function(cb) {
      var armored, esc, expansions, id, inner, o, opts, out, outer, pgp, raw, s, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    Base.prototype.generate_outer = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.hex_to_buf({
            hex_str: (_ref4 = inner.obj) != null ? _ref4.prev : void 0
          }, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.hex_to_buf({
              hex_str: (_ref4 = inner.obj) != null ? (_ref5 = _ref4.high_skip) != null ? _ref5.hash : void 0 : void 0
            }, esc(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
            ...
            var _ref4;
            if (((_ref4 = inner.obj) != null ? _ref4.high_skip : void 0) != null) {
              high_skip = {
    ...
    Base.prototype.sanity_check_proof_text = function(_arg, cb) {
      var args, b, b64s, check_for, err, len_floor, msg, proof_text, s, slack, _i, _len, _ref4;
      ...
      if (this.is_short()) {
        ...
        _ref4 = kbpgp.ukm.decode_sig({
          armored: args.sig
        }), err = _ref4[0], msg = _ref4[1];
    ...
    OuterLink.parse = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref4;
          err = ret = null;
          if ((_ref4 = arr.length) !== 5 && _ref4 !== 6 && _ref4 !== 7 && _ref4 !== 9) {
