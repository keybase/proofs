      ...
      (function(__iced_k) {
        if (err == null) {
          (function(__iced_k) {
            ...
            return __iced_k(err != null ? void 0 : (sw = l.signed_with) == null ? err = new Error("Expected a signature on the payload message") : (_this.km.find_pgp_key((b = sw.get_key_id()))) == null ? err = new Error("Failed sanity check; didn't have a key for '" + (b.toString('hex')) + "'") : void 0);
          });
        } else {
          return __iced_k();
        }
