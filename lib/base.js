...
(function() {
  var Base, KCP, Message, SHA256, Verifier, WordArray, akatch, base64u, bufeq_secure, constants, decode, iced, json_stringify_sorted, kbpgp, make_esc, make_ids, sha256, streq_secure, triplesec, unix_time, __iced_k, __iced_k_noop, _ref;
  ...
  _ref = kbpgp.util, akatch = _ref.akatch, bufeq_secure = _ref.bufeq_secure, json_stringify_sorted = _ref.json_stringify_sorted, unix_time = _ref.unix_time, base64u = _ref.base64u, streq_secure = _ref.streq_secure;
    ...
    Verifier.prototype._check_json = function(cb) {
      ...
      (function(__iced_k) {
        if ((n = _this.literals.length) !== 1) {
          ...
          (function(__iced_k) {
            try {
              _this.json = JSON.parse((l = _this.literals[0]).data);
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "src/base.iced",
