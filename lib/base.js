...
(function() {
  var Base, KCP, SHA256, WordArray, base64u, constants, iced, kbpgp, triplesec, unix_time, __iced_k, __iced_k_noop, _ref;
  ...
  Base = (function() {
    ...
    Base.prototype.generate = function(cb) {
      ...
      out = null;
      json = kbpgp.utils.json_stringify_sorted(this.json());
      (function(__iced_k) {
