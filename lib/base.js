...
(function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/robert/Desktop/proofs/src/base.iced",
  ...
  Base = (function() {
    ...
    Base.prototype._v_check = function(_arg, cb) {
      var a, b, err, json, key, seq_type, stanza_error, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      json = _arg.json;
      seq_type = function(v) {
        if (v != null) {
          return v;
    ...
    Base.prototype._check_stanzas = function(json) {
      ...
      for (stanza in _ref4) {
        _ = _ref4[stanza];
        if (!((__indexOf.call(this._required_stanzas(), stanza) >= 0) || (__indexOf.call(this._optional_stanzas(), stanza) >= 0))) {
