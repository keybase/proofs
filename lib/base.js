      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          if (!/^[\x20-\x7e]+$/.test(json_str_utf8)) {
            return __iced_k(err = new Error("All JSON proof characters must be in the ASCII set (properly escaped UTF8 is permissible)"));
          } else {
            ...
            (function(__iced_k) {
              if (err == null) {
                (function(__iced_k) {
                  if (_this.strict && ((ours = json_stringify_sorted(_this.json)) !== json_str_utf8)) {
