...
(function() {
  ...
  Verifier = (function() {
    ...
    Verifier.prototype._check_json_formatting = function(cb) {
      var err;
      err = null;
      return cb(err);
    };
    ...
    Verifier.prototype._check_json = function(cb) {
      var e, err, json_str_buf, json_str_utf8, ours, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _ref2;
          if (!/^[\x20-\x7e]+$/.test(json_str_utf8)) {
            return __iced_k(err = new Error("All JSON proof characters must be in the ASCII set"));
          } else {
            ...
            (function(__iced_k) {
              if (err == null) {
                ours = json_stringify_sorted(_this.json);
                (function(__iced_k) {
                  if (ours !== json_str_utf8) {
                    return __iced_k(err = new Error("non-canonlical JSON found in strict mode (" + ours + " v " + json_str_utf8 + ")"));
                  } else {
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                        parent: ___iced_passed_deferral,
  ...
  Base = (function() {
    ...
    Base.prototype.generate_json = function(_arg, cb) {
      var ctime, ekid, err, expire_in, fp, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
