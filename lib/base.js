...
(function() {
  ...
  Base = (function() {
    ...
    Base.prototype.generate_json = function(_arg, cb) {
      ...
      ret = {
        seqno: this.seqno,
        prev: this.prev,
        hprev_seqno: this.hprev_seqno || null,
        hprev_hash: this.hprev_hash || null,
        ctime: ctime,
  ...
  OuterLink = (function() {
    function OuterLink(_arg) {
      this.version = _arg.version, this.seqno = _arg.seqno, this.prev = _arg.prev, this.hash = _arg.hash, this.type = _arg.type, this.seq_type = _arg.seq_type, this.ignore_if_unsupported = _arg.ignore_if_unsupported, this.hprev_seqno = _arg.hprev_seqno, this.hprev_hash = _arg.hprev_hash;
    }
    ...
    OuterLink.prototype.get_hprev_seqno = function() {
      return this.hprev_seqno || void 0;
    };

    OuterLink.prototype.get_hprev_hash = function() {
      return this.hprev_hash || void 0;
    };
    ...
    OuterLink.prototype.pack = function() {
      ...
      if ((this.seqno === 0 && this.prev === null) || ((this.hprev_seqno != null) && (this.hprev_hash != null))) {
        arr.push(this.hprev_seqno);
        arr.push(this.hprev_hash);
      }
