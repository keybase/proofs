...
(function() {
  ...
  Verifier = (function() {
    ...
    Verifier.prototype._check_inner_outer_match = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          err = (a = outer.type) !== (b = _this.base._type_v2(has_revoke(inner_obj.body))) ? new Error("Type mismatch: " + a + " != " + b) : (a = outer.version) !== (b = constants.versions.sig_v2) ? new Error("Bad version: " + a + " != " + b) : !bufeq_secure((a = outer.hash), (b = hash_sig(inner_buf))) ? new Error("hash mismatch: " + (a.toString('hex')) + " != " + (b.toString('hex'))) : (a = outer.seqno) !== (b = inner_obj.seqno) ? new Error("wrong seqno: " + a + " != " + b) : !compare_hash_buf_to_str((a = outer.prev), (b = inner_obj.prev)) ? new Error("wrong prev: " + (a.toString('hex')) + " != " + b) : null;
          return cb(err, outer);
        };
      })(this));
    };
  ...
  Base = (function() {
    ...
    Base.prototype.generate = function(cb) {
      var armored, esc, id, inner, json, json_obj, out, pgp, raw, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
