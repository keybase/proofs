...
(function() {
  ...
  Verifier = (function() {
    ...
    Verifier.prototype._sanity_check_high_skip = function(cb) {
      var err, high_skip, seqno, _ref2;
      err = null;
      _ref2 = this.json, seqno = _ref2.seqno, high_skip = _ref2.high_skip;
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.hex_to_buf({
              hex_str: (_ref2 = inner.obj) != null ? (_ref3 = _ref2.high_skip) != null ? _ref3.hash : void 0 : void 0
            }, esc(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
            ...
            var _ref2;
            if (((_ref2 = inner.obj) != null ? _ref2.high_skip : void 0) != null) {
              high_skip = {
    ...
    OuterLink.parse = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref2;
          err = ret = null;
          if ((_ref2 = arr.length) !== 5 && _ref2 !== 6 && _ref2 !== 7 && _ref2 !== 9) {
