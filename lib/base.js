...
(function() {
  var Base, KCP, Message, SHA256, Verifier, WordArray, add_ids, akatch, base64u, bufeq_secure, constants, decode, hash_sig, iced, json_stringify_sorted, katch, kbpgp, make_esc, make_ids, sig_id_to_short_id, streq_secure, triplesec, unix_time, util, __iced_k, __iced_k_noop, _ref;
  ...
  exports.hash_sig = hash_sig = function(pgp) {
    return (new SHA256).bufhash(new Buffer(pgp, 'utf8'));
  };

  add_ids = function(pgp, out) {
  ...
  Verifier = (function() {
    function Verifier(_arg, km, base) {
      this.pgp = _arg.pgp, this.id = _arg.id, this.short_id = _arg.short_id, this.skip_ids = _arg.skip_ids;
      this.km = km;
      this.base = base;
    }
  ...
  Base = (function() {
    function Base(_arg) {
      this.km = _arg.km, this.seqno = _arg.seqno, this.user = _arg.user, this.host = _arg.host, this.prev = _arg.prev;
    }
    ...
    Base.prototype.verify = function(obj, cb) {
      var esc, json_obj, json_str, verifier, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
