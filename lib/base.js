              ...
              (function(__iced_k) {
                ...
                _this.sig_eng.unbox(msg, __iced_deferrals.defer({
                  assign_fn: (function(__slot_1) {
                    return function() {
                      err = arguments[0];
                      return __slot_1.payload = arguments[1];
                    };
                  })(_this),
                  lineno: 105
                }));
  ...
  Base = (function() {
    ...
    Base.prototype._v_check_key = function(key) {
      if ((key != null ? key.kid : void 0) != null) {
        return this._v_check_kid(key.kid);
      } else if ((key != null ? key.fingerprint : void 0) != null) {
        return this._v_check_fingerprint(key);
      } else {
        return new Error("need either a 'body.key.kid' or a 'body.key.fingerprint'");
      }
    };

    Base.prototype._v_check_kid = function(kid) {
      var a, err;
      if (!bufeq_secure((a = this.km.get_ekid()), new Buffer(key, "hex"))) {
