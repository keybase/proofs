...
(function() {
  ...
  Verifier = (function() {
    ...
    Verifier.prototype.verify_v2 = function(cb) {
      var esc, inner_buf, json_obj, json_str, outer_raw, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "Verifier::verfiy");
      (function(_this) {
    ...
    Verifier.prototype._check_inner_outer_match = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref2;
          err = (a = outer.type) !== (b = _this.base._type_v2(((_ref2 = inner_obj.body) != null ? _ref2.revoke : void 0) != null)) ? new Error("Type mismatch: " + a + " != " + b) : (a = outer.version) !== (b = constants.versions.sig_v2) ? new Error("Bad version: " + a + " != " + b) : !bufeq_secure((a = outer.hash), (b = hash_sig(inner_buf))) ? new Error("hash mismatch: " + (a.toString('hex')) + " != " + (b.toString('hex'))) : (a = outer.seqno) !== (b = inner_obj.seqno) ? new Error("wrong seqno: " + a + " != " + b) : !compare_hash_buf_to_str((a = outer.prev), (b = inner_obj.prev)) ? new Error("wrong prev: " + (a.toString('hex')) + " != " + b) : null;
          return cb(err);
        };
      })(this));
    };
  ...
  Base = (function() {
    ...
    Base.prototype.generate_json = function(_arg, cb) {
      var ctime, e, ekid, err, expire_in, fp, pick, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    Base.prototype.generate_v2 = function(cb) {
      var armored, esc, id, inner, o, out, outer, pgp, raw, s, short_id, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "generate");
      out = null;
    ...
    Base.prototype.generate_outer = function(_arg, cb) {
      var e, err, inner, p, prev_buf, ret;
      inner = _arg.inner;
