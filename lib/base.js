...
(function() {
  ...
  Verifier = (function() {
                  ...
                  (function(__iced_k) {
                    if (_this.json.hprev_info != null) {
                      (function(__iced_k) {
                        ...
                        _this._sanity_check_hprev_info(esc(__iced_deferrals.defer({
                          lineno: 129
                        })));
                        __iced_deferrals._fulfill();
                      })(__iced_k);
    ...
    Verifier.prototype._sanity_check_hprev_info = function(cb) {
      var err, hprev_info, seqno, _ref2;
      err = null;
      _ref2 = this.json, seqno = _ref2.seqno, hprev_info = _ref2.hprev_info;
      if (hprev_info.hash && (hprev_info.seqno == null)) {
        err = new Error("Cannot provide hprev hash but not hprev seqno.");
      } else if (seqno === 1 && hprev_info.seqno !== 0) {
        err = new Error("First seqno must provide hprev seqno 0, if hprev_info is provided.");
      } else if (hprev_info.seqno === 0 && (hprev_info.hash != null)) {
  ...
  Base = (function() {
    ...
    Base.prototype.generate_json = function(_arg, cb) {
      ...
      if (this.hprev_info != null) {
        ret.hprev_info = this.hprev_info;
      }
      if (this.client != null) {
  ...
  OuterLink = (function() {
    function OuterLink(_arg) {
      this.version = _arg.version, this.seqno = _arg.seqno, this.prev = _arg.prev, this.hash = _arg.hash, this.type = _arg.type, this.seq_type = _arg.seq_type, this.ignore_if_unsupported = _arg.ignore_if_unsupported, this.hprev_info = _arg.hprev_info;
    }
    ...
    OuterLink.prototype.get_hprev_info = function() {
      return this.hprev_info || null;
    };
    ...
    OuterLink.prototype.pack = function() {
      ...
      if (this.hprev_info != null) {
        arr.push(this.hprev_info.seqno);
        arr.push(this.hprev_info.hash);
      }
