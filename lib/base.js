...
(function() {
  var Base, GenericBinding, OuterLink, SHA256, Verifier, WordArray, add_ids, akatch, base64_extract, base64u, bufeq_secure, bufferify, cieq, compare_hash_buf_to_str, constants, errors, errsan, has_revoke, hash_sig, iced, isString, json_stringify_sorted, katch, kbpgp, make_esc, make_ids, pgp_utils, proof_text_check_to_med_id, proof_type_to_string, purepack, sig_id_to_med_id, sig_id_to_short_id, streq_secure, trim, triplesec, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  has_revoke = function(o) {
    ...
    if ((o != null ? o.revoke : void 0) == null) {
      ...
      return true;
    } else if (((_ref3 = o.revoke.sig_ids) != null ? _ref3.length : void 0) > 0) {
      return true;
    } else if (o.revoke.kid != null) {
      return true;
    } else if (((_ref4 = o.revoke.kids) != null ? _ref4.length : void 0) > 0) {
      return true;
    } else {
      return false;
    }
  ...
  Verifier = (function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/me/code/src/github.com/keybase/proofs/src/base.iced",
    ...
    Verifier.prototype._check_ids = function(body, cb) {
      var err, id, short_id, _ref3;
      _ref3 = make_ids(body), short_id = _ref3.short_id, id = _ref3.id;
    ...
    Verifier.prototype._sanity_check_high_skip = function(cb) {
      var err, high_skip, seqno, _ref3;
      err = null;
      _ref3 = this.json, seqno = _ref3.seqno, high_skip = _ref3.high_skip;
        ...
        return function() {
          (function(__iced_k) {
            ...
            if ((err == null) && _this.make_ids) {
              _ref3 = make_ids(body), _this.short_id = _ref3.short_id, _this.id = _ref3.id;
            }
  ...
  Base = (function() {
        ...
        return (function(__iced_k) {
          if (_this._full_pgp_hash === void 0) {
            ...
            (function(__iced_k) {
              ...
              if ((_ref3 = _this._v_pgp_km()) != null) {
                _ref3.pgp_full_hash({}, esc(__iced_deferrals.defer({
    ...
    Base.prototype._v_check_user = function(_arg) {
      var a, b, e, has_user_id, json, v, x, _ref10, _ref11, _ref12, _ref13, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      json = _arg.json;
      has_user_id = false;
      if (json != null ? (_ref3 = json.body) != null ? (_ref4 = _ref3.key) != null ? _ref4.username : void 0 : void 0 : void 0) {
        if (!cieq((a = json != null ? (_ref5 = json.body) != null ? (_ref6 = _ref5.key) != null ? _ref6.username : void 0 : void 0 : void 0), (b = this.user.local.username))) {
      ...
      if (json != null ? (_ref7 = json.body) != null ? (_ref8 = _ref7.key) != null ? _ref8.uid : void 0 : void 0 : void 0) {
        if ((a = json != null ? (_ref9 = json.body) != null ? (_ref10 = _ref9.key) != null ? _ref10.uid : void 0 : void 0 : void 0) !== (b = this.user.local.uid)) {
      ...
      if (((v = this.user.local.emails) != null) && ((e = json != null ? (_ref11 = json.body) != null ? (_ref12 = _ref11.key) != null ? _ref12.email : void 0 : void 0 : void 0) != null)) {
        if (_ref13 = e.toLowerCase(), __indexOf.call((function() {
    ...
    Base.prototype._v_check = function(_arg, cb) {
      var a, b, err, json, key, section_error, seq_type, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3, _ref4, _ref5, _ref6;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      json = _arg.json;
      seq_type = function(v) {
    ...
    Base.prototype._check_sections = function(json) {
      var section, _, _i, _len, _ref3, _ref4, _ref5;
      _ref3 = this._required_sections();
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        section = _ref3[_i];
        if (!(json != null ? (_ref4 = json.body) != null ? _ref4[section] : void 0 : void 0)) {
      ...
      if (!this._is_wildcard_link()) {
        _ref5 = json != null ? json.body : void 0;
        for (section in _ref5) {
          _ = _ref5[section];
    ...
    Base.prototype.generate_json = function(_arg, cb) {
      var ctime, e, ekid, err, expire_in, fp, pick, ret, version, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      _ref3 = _arg != null ? _arg : {}, expire_in = _ref3.expire_in, version = _ref3.version;
      err = null;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              var _ref3;
              _ref3 = make_ids(raw), short_id = _ref3.short_id, id = _ref3.id;
              out = {
                pgp: pgp,
                json: json,
                id: id,
    ...
    Base.prototype.generate_versioned = function(_arg, cb) {
      ...
      switch (version) {
        case constants.versions.sig_v2:
    ...
    Base.prototype.generate_outer = function(_arg, cb) {
      var esc, high_skip, high_skip_hash_buf, inner, prev_buf, ret, unpacked, x, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      inner = _arg.inner;
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.hex_to_buf({
            hex_str: (_ref3 = inner.obj) != null ? _ref3.prev : void 0
          }, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this.hex_to_buf({
              hex_str: (_ref3 = inner.obj) != null ? (_ref4 = _ref3.high_skip) != null ? _ref4.hash : void 0 : void 0
            }, esc(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
            ...
            var _ref3;
            if (((_ref3 = inner.obj) != null ? _ref3.high_skip : void 0) != null) {
              high_skip = {
    ...
    Base.prototype.sanity_check_proof_text = function(_arg, cb) {
      var args, b, b64s, check_for, err, len_floor, msg, proof_text, s, slack, _i, _len, _ref3;
      ...
      if (this.is_short()) {
        ...
        _ref3 = kbpgp.ukm.decode_sig({
          armored: args.sig
        }), err = _ref3[0], msg = _ref3[1];
  ...
  OuterLink = (function() {
    function OuterLink(_arg) {
      this.version = _arg.version, this.seqno = _arg.seqno, this.prev = _arg.prev, this.hash = _arg.hash, this.type = _arg.type, this.seq_type = _arg.seq_type, this.ignore_if_unsupported = _arg.ignore_if_unsupported, this.high_skip = _arg.high_skip;
    }

    OuterLink.parse = function(_arg, cb) {
      var arg, arr, err, esc, raw, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      raw = _arg.raw;
      ...
      (function(_this) {
        ...
        return function() {
          var _ref3;
          err = ret = null;
          if ((_ref3 = arr.length) !== 5 && _ref3 !== 6 && _ref3 !== 7 && _ref3 !== 9) {
    ...
    OuterLink.prototype.get_high_skip = function() {
      return this.high_skip || null;
    };
    ...
    OuterLink.prototype.pack = function() {
      ...
      if (this.high_skip != null) {
        arr.push(this.high_skip.seqno);
        arr.push(this.high_skip.hash);
      }
