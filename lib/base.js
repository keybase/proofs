...
(function() {
  ...
  Base = (function() {
    ...
    Base.prototype._v_check = function(_arg, cb) {
      var a, b, err, json, key, section_error, seq_type, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      json = _arg.json;
      seq_type = function(v) {
        if (v != null) {
          return v;
