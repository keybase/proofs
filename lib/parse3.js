...
(function() {
  var bufeq_fast, constants, decode_hex, is_dict, is_hex, is_int, pack, unpack, unpack_strict,
  ...
  exports.decode_hex = decode_hex = function(s) {
    var buf;
    if (typeof s !== 'string') {
      return null;
    }
    buf = Buffer.from(s, 'hex');
    if (buf.toString('hex') !== s.toLowerCase()) {
      return null;
    }
    return buf;
  };
  ...
  exports.unhex = function(b) {
    ...
    if (b == null) {
      ...
      return b;
    } else if (typeof b === 'string' && ((h = decode_hex(b)) != null)) {
      return h;
    } else {
