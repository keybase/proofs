...
(function() {
  ...
  exports.PerUserKey = PerUserKey = (function(_super) {
    ...
    PerUserKey.prototype.get_field = function() {
      return "per_user_key";
    };
    ...
    PerUserKey.prototype._find_fields = function(_arg) {
      ...
      json = _arg.json;
      if (typeof (v = json != null ? (_ref1 = json.body) != null ? (_ref2 = _ref1.per_user_key) != null ? _ref2.generation : void 0 : void 0 : void 0) !== 'number') {
        return new Error("Need per_user_key.generation to be an integer");
