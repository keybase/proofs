...
(function() {
  var Array, Binary, Bool, ChainType, Dict, Int, KID, LinkType, Node, Object, Path, PtkType, Seqno, String, Struct, Time, Value, mkerr, parse,
  ...
  Binary = (function(_super) {
    ...
    function Binary(_arg) {
      ...
      this._len = len;
      this._bottom_bytes = bottom_bytes;
    }
