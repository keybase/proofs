...
(function() {
  var Array, Binary, Bool, ChainType, Dict, Int, KID, LinkType, Node, Object, Or, Path, PtkType, Seqno, String, StringEnum, Struct, Time, Value, get_own, has_own, is_reserved_key_name, mkerr, parse, _ref,
  ...
  _ref = require('./util'), has_own = _ref.has_own, get_own = _ref.get_own;

  mkerr = function(path, err) {
    return new Error("At " + (path.toString()) + ": " + err);
  };

  is_reserved_key_name = function(k) {
    return k === '__proto__';
  };
  ...
  Dict = (function(_super) {
    ...
    function Dict(_arg) {
      ...
      keys = _arg.keys;
      for (k in keys) {
        if (is_reserved_key_name(k)) {
          throw new Error("schema key name is not allowed: " + k);
        }
      }
      this._keys = keys;
    ...
    Dict.prototype._check = function(_arg) {
      var checker, err, k, new_path, obj, path, v, _ref1;
      path = _arg.path, obj = _arg.obj;
      ...
      for (k in obj) {
        ...
        if (is_reserved_key_name(k)) {
          return mkerr(new_path, "key name is not allowed");
        }
        if ((checker = get_own(this._keys, k)) == null) {
      ...
      for (k in _ref1) {
        v = _ref1[k];
        new_path = path.extend(k);
        if (!has_own(obj, k) && !v.is_optional()) {
  ...
  Binary = (function(_super) {
    ...
    Binary.prototype._check = function(_arg) {
      var err, obj, path, _, _ref1;
      path = _arg.path, obj = _arg.obj;
      _ref1 = this._convert_and_check({
        path: path,
        obj: obj
  ...
  KID = (function(_super) {
    ...
    KID.prototype._check = function(_arg) {
      var err, obj, path, typ, _ref1, _ref2;
      path = _arg.path, obj = _arg.obj;
      _ref1 = this._convert_and_check({
        path: path,
        obj: obj
      }), err = _ref1[0], obj = _ref1[1];
      if (err != null) {
        return err;
      }
      typ = this._encryption ? [0x21] : [0x20, 0x01, 0x11, 0x13, 0x16];
      if ((obj[0] !== 0x01) || (_ref2 = obj[1], __indexOf.call(typ, _ref2) < 0) || (obj.slice(-1)[0] !== 0x0a)) {
  ...
  String = (function(_super) {
    ...
    String.prototype._check = function(_arg) {
      var max_length, obj, path, _ref1;
      path = _arg.path, obj = _arg.obj;
      if (typeof obj !== 'string' || obj.length === 0) {
        return mkerr(path, "value must be a string");
      }
      if ((max_length = (_ref1 = this._args) != null ? _ref1.max_length : void 0) != null) {
    ...
    function StringEnum(_arg) {
      ...
      for (_i = 0, _len = values.length; _i < _len; _i++) {
        ...
        if (is_reserved_key_name(v)) {
          throw new Error("enum value is not allowed: " + v);
        }
        this._values[v] = true;
      }
    }
  ...
  Or = (function(_super) {
    ...
    Or.prototype._check = function(_arg) {
      var obj, ok, path, t, _i, _len, _ref1;
      path = _arg.path, obj = _arg.obj;
      ok = false;
      _ref1 = this._terms;
