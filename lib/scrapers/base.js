...
(function() {
  var BaseScraper, b64find, constants, decode_sig, iced, ipaddress, pkg, sncmp, space_normalize, user_agent, v_codes, __iced_k, __iced_k_noop;
    ...
    BaseScraper.prototype._get_url_body = function(opts, cb) {
      ...
      followRedirect = (function(_this) {
        return function(response) {
          ...
          _ref = url.parse(response.headers.location), hostname = _ref.hostname, port = _ref.port, search = _ref.search;
          fail = function(why) {
