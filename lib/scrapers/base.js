...
(function() {
  var BaseScraper, b64find, constants, decode_sig, iced, pkg, sncmp, space_normalize, urlmod, user_agent, v_codes, __iced_k, __iced_k_noop;
  ...
  BaseScraper = (function() {
          ...
          if (err == null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/me/code/src/github.com/keybase/proofs/src/scrapers/base.iced",
    ...
    BaseScraper.prototype._get_url_body = function(opts, cb) {
      var err, rc, response, ___iced_passed_deferral, __iced_deferrals, __iced_k, _base;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
