...
(function() {
  ...
  BaseScraper = (function() {
    ...
    BaseScraper.prototype.validate = function(obj, cb) {
      ...
      (function(__iced_k) {
        if (!_this._check_api_url(obj)) {
          ...
          (function(__iced_k) {
            ...
            _this._validate_text_check(obj, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
        ...
        (function(__iced_k) {
          if (err == null) {
            (function(__iced_k) {
              ...
              _this.check_status(obj, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    err = arguments[0];
