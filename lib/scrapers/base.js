...
(function() {
  ...
  BaseScraper = (function() {
    ...
    BaseScraper.prototype.validate = function(_arg, cb) {
      var err, payload_text_check, sig, url, username, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      url = _arg.url, username = _arg.username, sig = _arg.sig, payload_text_check = _arg.payload_text_check;
      err = null;
      (function(__iced_k) {
        if (!_this._check_url({
          url: url,
          ...
          return __iced_k(err = new Error("check url failed for " + url + ", " + username));
        } else {
          (function(__iced_k) {
            ...
            _this._validate_text_check({
              sig: sig,
              payload_text_check: payload_text_check
