...
(function() {
  var BaseScraper, b64find, constants, decode_sig, iced, parse_int_or_undefined, pkg, sncmp, space_normalize, urlmod, user_agent, v_codes, __iced_k, __iced_k_noop;
  ...
  BaseScraper = (function() {
    ...
    BaseScraper.prototype._get_url_body = function(opts, cb) {
      var err, rc, response, rl_limit, rl_remaining, rl_reset, ___iced_passed_deferral, __iced_deferrals, __iced_k, _base;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
            ...
            try {
              if (opts.json) {
                return response.json().then(function(body) {
                  ...
                  return cb(err, v_codes.BASE_HARD_ERROR);
                });
              } else {
