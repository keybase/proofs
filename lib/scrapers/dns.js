...
(function() {
  ...
  exports.DnsScraper = DnsScraper = (function(_super) {
    ...
    DnsScraper.prototype.check_status = function(_arg, cb) {
      var api_url, d, err, proof_text_check, records, ___iced_passed_deferral, __iced_deferrals, __iced_k;
        ...
        return (function(__iced_k) {
          if (d != null) {
            ...
            (function(__iced_k) {
              ...
              return __iced_k(typeof err !== "undefined" && err !== null ? void 0 : (__indexOf.call(records, proof_text_check) >= 0) ? v_codes.OK : v_codes.NOT_FOUND);
            });
          }
        });
      })(this)((function(_this) {
