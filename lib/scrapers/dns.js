...
(function() {
  ...
  exports.DnsScraper = DnsScraper = (function(_super) {
    ...
    DnsScraper.prototype.check_status = function(_arg, cb) {
      var api_url, domain, err, proof_text_check, rc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    DnsScraper.prototype._check_status = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          return rc = typeof err !== "undefined" && err !== null ? (_this.log("| DNS error: " + err), v_codes.DNS_ERROR) : (__indexOf.call(records, proof_text_check) >= 0) ? v_codes.OK : (_this.log("| DNS failed; found TXT entries: " + (JSON.stringify(records))), v_codes.NOT_FOUND);
        };
      })(this));
    };
