...
(function() {
  ...
  exports.make_TXT_record = function(z) {
    return "keybase-validate=" + z;
  };
  ...
  exports.DnsScraper = DnsScraper = (function(_super) {
    ...
    DnsScraper.prototype._check_api_url = function(_arg) {
      ...
      return api_url.toLowerCase().indexOf(this.make_domain({
        domain: domain
      })) >= 0;
    };
    ...
    DnsScraper.prototype._validate_text_check = function(_arg) {
      ...
      if (err == null) {
        ...
        if (proof_text_check !== make_TXT_record(med_id)) {
    ...
    DnsScraper.prototype.check_status = function(_arg, cb) {
      var api_url, d, err, hostname, proof_text_check, protocol, records, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (d != null) {
            return __iced_k(new Error("no domain found in URL " + api_url));
          } else {
            (function(__iced_k) {
              ...
              return __iced_k(typeof err !== "undefined" && err !== null ? void 0 : __indexOf.call(records, d) >= 0 ? v_codes.OK : v_codes.NOT_FOUND);
            });
          }
        });
      })(this)((function(_this) {
