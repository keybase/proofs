      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/me/code/src/github.com/keybase/proofs/src/scrapers/facebook.iced",
        ...
        return function() {
          ...
          if (link_text.trim() !== proof_text_check.trim()) {
            _this.log("failed to find attachment title '" + proof_text_check + "' in Facebook post " + desktop_url + ": " + (JSON.stringify(link_text.trim())) + " != " + (JSON.stringify(proof_text_check.trim())));
            return cb(null, v_codes.TEXT_NOT_FOUND);
          }
