...
(function() {
  ...
  exports.GenericWebSiteScraper = GenericWebSiteScraper = (function(_super) {
    ...
    GenericWebSiteScraper.prototype.check_status = function(_arg, cb) {
      var api_url, err, hostname, proof_text_check, protocol, raw, rc, stripr, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        ...
        return function() {
          if (rc !== v_codes.OK) {
            rc;
          } else if ((stripr(raw).indexOf(proof_text_check)) >= 0) {
            v_codes.OK;
          } else {
            v_codes.NOT_FOUND;
          }
