...
_break()
    ...
    GithubScraper.prototype._check_url = function(_arg) {
      var url, username;
      url = _arg.url, username = _arg.username;
      return url.indexOf("https://api.github.com/users/" + username + "/gists") === 0;
    };

    GithubScraper.prototype._validate_text_check = function(_arg) {
      var err, msg, payload_text_check, sig, _ref;
      sig = _arg.sig, payload_text_check = _arg.payload_text_check;
      _ref = decode(sig), err = _ref[0], msg = _ref[1];
      if ((err == null) && ("\n\n" + msg.raw()) !== payload_text_check) {
