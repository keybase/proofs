...
(function() {
  var BaseScraper, GithubScraper, b64find, constants, iced, v_codes, __iced_k, __iced_k_noop,
...
_break()
    ...
    GithubScraper.prototype._search_gist = function(_arg, cb) {
      var content, err, file, filename, gist, json, out, proof_text_check, ptc_buf, rc, u, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    GithubScraper.prototype.check_status = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          ptc_buf = new Buffer(proof_text_check, "base64");
          rc = rc !== v_codes.OK ? rc : b64find(raw, ptc_buf) ? v_codes.OK : v_codes.NOT_FOUND;
          return cb(err, rc);
        };
      })(this));
    };
