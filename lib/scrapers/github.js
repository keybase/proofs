...
(function() {
  ...
  exports.GithubScraper = GithubScraper = (function(_super) {
    ...
    GithubScraper.prototype.hunt2 = function(_arg, cb) {
      var err, gist, json, out, rc, signature, url, username, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
...
_break()
    ...
    GithubScraper.prototype._search_gist = function(_arg, cb) {
      var content, err, file, filename, gist, id, json, out, rc, signature, u, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      gist = _arg.gist, signature = _arg.signature;
      out = {};
      (function(__iced_k) {
        if ((u = gist.url) == null) {
