...
(function() {
  ...
  exports.WebSiteScraper = WebSiteScraper = (function(_super) {
    ...
    WebSiteScraper.prototype.hunt2 = function(_arg, cb) {
      var err, hostname, out, protocol, signature, url;
      hostname = _arg.hostname, protocol = _arg.protocol, signature = _arg.signature;
      err = null;
      if ((hostname == null) || (protocol == null) || (signature == null)) {
    ...
    WebSiteScraper.prototype.check_status = function(_arg, cb) {
      var api_url, err, raw, rc, signature, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      api_url = _arg.api_url, signature = _arg.signature;
      (function(__iced_k) {
