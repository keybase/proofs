...
(function() {
  ...
  exports.TwitterScraper = TwitterScraper = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/keybase-proofs/src/scrapers/twitter.iced",
    ...
    TwitterScraper.prototype.users_lookup = function(_arg, cb) {
      var batch_size, cursor_wait, done, err, i, identifier, ids, include_entities, input_list, j, json, key, map, query, r, rc, res, responses, screen_names, u, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    TwitterScraper.prototype._comp_twitter_url = function(url_a_str, url_b_str) {
      var twitter_hosts, url_a, url_b;
      if (!url_a_str || !url_b_str) {
        return false;
      }
      ...
      try {
        ...
        return twitter_hosts.includes(url_a.host) && twitter_hosts.includes(url_b.host) && url_a.protocol === url_b.protocol && url_a.pathname === url_b.pathname && url_a.search === url_b.search && url_a.hash === url_b.hash;
      } catch (_error) {
        return false;
      }
    };
      ...
      (function(_this) {
        ...
        return function() {
          if (!err && rc === v_codes.OK) {
            ...
            if (!(_this._comp_twitter_url(body_obj.url, api_url))) {
            ...
            _ = api_url_matches[0], _ = api_url_matches[1], username_from_url = api_url_matches[2], tweet_id = api_url_matches[3];
            ...
            _ = author_url_matches[0], _ = author_url_matches[1], author_username = author_url_matches[2];
