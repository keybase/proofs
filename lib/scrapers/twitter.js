...
(function() {
  ...
  exports.TwitterScraper = TwitterScraper = (function(_super) {
    ...
    TwitterScraper.prototype.hunt2 = function(_arg, cb) {
      var $, api_url, err, html, human_url, i, item, out, p, rc, remote_id, signature, stream, stream_item, u, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    TwitterScraper.prototype.find_sig_in_tweet = function(_arg) {
      var inside, m, p, rc, signature, tweet_p, x;
      tweet_p = _arg.tweet_p, signature = _arg.signature;
      inside = tweet_p.text();
      x = /^(@[a-zA-Z0-9_-]+\s+)/;
      this.log("+ Checking tweet '" + (tweet_p.text()) + "' for signature '" + signature + "'");
