...
(function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/zapu/Projects/KB/proofs/src/scrapers/twitter.iced",
  ...
  exports.TwitterScraper = TwitterScraper = (function(_super) {
    ...
    TwitterScraper.prototype.check_status = function(_arg, cb) {
      var $, api_url, api_url_matches, author_url_matches, author_username, body_obj, err, new_api_url, proof_text_check, rc, remote_id, tweet_id, tweet_p, u, username, username_from_url, _, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          if (!err && rc === v_codes.OK) {
            ...
            if (typeof body_obj.author_url !== 'string') {
            ...
            if (typeof body_obj.html !== 'string') {
