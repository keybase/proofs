...
(function() {
  ...
  exports.TwitterScraper = TwitterScraper = (function(_super) {
    ...
    TwitterScraper.prototype.hunt2 = function(_arg, cb) {
      var $, api_url, err, html, human_url, item, out, p, rc, remote_id, signature, stream, stream_item, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      username = _arg.username, signature = _arg.signature;
      out = {};
      rc = v_codes.OK;
      (function(_this) {
    ...
    TwitterScraper.prototype.find_sig_in_tweet = function(_arg) {
      var inside, log, m, p, rc, signature, tweet, x;
      tweet = _arg.tweet, signature = _arg.signature, log = _arg.log;
      inside = tweet;
      x = /^(@[a-zA-Z0-9_-]+\s+)/;
      if (log != null) {
