...
(function() {
  ...
  exports.TwitterScraper = TwitterScraper = (function(_super) {
    ...
    TwitterScraper.prototype.hunt2 = function(_arg, cb) {
      var api_url, err, human_url, i, id, json, name, out, proof_text_check, rc, remote_id, text, u, username, ___iced_passed_deferral, __iced_deferrals, __iced_k;
        ...
        return function() {
          ...
          if (rc !== v_codes.OK) {
            ...
            for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
              _ref2 = _ref1[i], text = _ref2.text, id = _ref2.id;
