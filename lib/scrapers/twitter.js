...
(function() {
  ...
  exports.TwitterScraper = TwitterScraper = (function(_super) {
    ...
    TwitterScraper.prototype.check_status = function(_arg, cb) {
      var $, api_url, api_url_matches, author_url_matches, author_username, body, body_obj, e, err, new_api_url, proof_text_check, rc, remote_id, tweet_id, tweet_p, u, username, username_from_url, _, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
