...
(function() {
  var BaseBearerToken, BaseScraper, Lock, TweetCache, TwitterBatchScraper, TwitterScraper, constants, iced, urlmod, v_codes, ws_normalize, __iced_k, __iced_k_noop, _ref,
  ...
  _ref = require('./base'), BaseScraper = _ref.BaseScraper, BaseBearerToken = _ref.BaseBearerToken;
        ...
        return function() {
          ...
          if (rc !== v_codes.OK) {
            ...
            for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
              _ref3 = _ref2[i], id = _ref3.id, created_at = _ref3.created_at, username = _ref3.username, text = _ref3.text;
          ...
          _this.log("| _hunt_batch returning: " + rc);
          return cb(null, rc);
        };
      })(this));
    };
