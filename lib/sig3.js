...
(function() {
  ...
  exports.OuterLink = OuterLink = (function() {
    ...
    OuterLink.decode = function(obj) {
      var err, schm;
      schm = schema.array([schema.value(3).name("version"), schema.seqno().name("seqno"), schema.binary(32).name("prev").optional(), schema.binary(32).name("inner_link"), schema.link_type().name("link_type"), schema.chain_type().name("chain_type"), schema.bool().name("ignore_if_unsupported")]);
