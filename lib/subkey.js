...
(function() {
  ...
  exports.SubkeyBase = SubkeyBase = (function(_super) {
    ...
    SubkeyBase.prototype._v_check = function(_arg, cb) {
      var a, b, eng, err, esc, json, payload, raw, rsk, sig, skm, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      json = _arg.json;
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            var _ref1, _ref2;
            if (((sig = json != null ? (_ref1 = json.body) != null ? (_ref2 = _ref1[_this.get_field()]) != null ? _ref2.reverse_sig : void 0 : void 0 : void 0) != null) && ((skm = _this.get_subkm()) != null)) {
