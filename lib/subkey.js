...
(function() {
  ...
  exports.SubkeyBase = SubkeyBase = (function(_super) {
    ...
    SubkeyBase.prototype._v_check = function(_arg, cb) {
      var a, b, eng, err, esc, extras, json, payload, raw, sig, skm, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      json = _arg.json;
            ...
            if (((sig = json != null ? (_ref1 = json.body) != null ? (_ref2 = _ref1[_this.get_field()]) != null ? (_ref3 = _ref2.reverse_sig) != null ? _ref3.sig : void 0 : void 0 : void 0 : void 0) != null) && ((skm = _this.get_subkm()) != null)) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  if ((a = payload.username) !== (b = _this.user.local.username)) {
                    err = new Error("Bad reverse sig in payload; unsername mismatch: " + a + " != " + b);
                  }
                  return __iced_k(err == null ? _this.reverse_sig = {
                    payload: raw,
                    kid: skm.get_ekid().toString('hex')
                  } : void 0);
                });
              });
            } else {
