          ...
          if (((sig = json != null ? (_ref1 = json.body) != null ? (_ref2 = _ref1[_this.get_field()]) != null ? _ref2.reverse_sig : void 0 : void 0 : void 0) != null) && (new_km != null)) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                return __iced_k((err = _this._match_json(json, payload)) != null ? void 0 : !streq_secure((a = json != null ? (_ref3 = json.body) != null ? (_ref4 = _ref3[_this.get_field()]) != null ? _ref4[_this.sibkid_slot()] : void 0 : void 0 : void 0), (b = rsk)) ? err = new Error("Sibkey KID mismatch: " + a + " != " + b) : _this.reverse_sig_kid = rsk);
              });
            });
          } else {
