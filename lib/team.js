...
(function() {
  var Base, ChangeMembership, EncKeyManager, Index, KeyManager, Leave, NewSubteam, RenameSubteam, Root, RotateKey, SubkeyBase, SubteamHead, TeamBase, constants, iced, json_stringify_sorted, make_esc, pgp_utils, streq_secure, unix_time, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  TeamBase = (function(_super) {
    ...
    TeamBase.prototype.get_field = function() {
      return "per_team_key";
    };
    ...
    TeamBase.prototype.need_reverse_sig = function(json) {
      var _ref2;
      return (json != null ? (_ref2 = json.body) != null ? _ref2.per_team_key : void 0 : void 0) != null;
    };
