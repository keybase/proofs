...
(function() {
  ...
  exports.TeamBase = TeamBase = (function(_super) {
          ...
          if (_this.kms != null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/me/code/proofs/src/team.iced",
    ...
    TeamBase.prototype.set_new_key_section = function(m) {
      ...
      if ((v = this.kms.appkey_derivation_version) != null) {
        m.appkey_derivation_version = v;
      }
    ...
    TeamBase.prototype._find_fields = function(_arg) {
      ...
      } else if (((v = json.appkey_derivation_version) != null) && (typeof v !== 'number' || parseInt(v) < 1)) {
        return new Error("Need per_team_key.appkey_derivation_version to be an integer >= 1 (got " + v + ")");
  ...
  exports.ChangeMembershipHigh = ChangeMembershipHigh = (function(_super) {
    __extends(ChangeMembershipHigh, _super);

    function ChangeMembershipHigh() {
      return ChangeMembershipHigh.__super__.constructor.apply(this, arguments);
    }

    ChangeMembershipHigh.prototype._type = function() {
      return constants.sig_types.team.change_membership_high;
    };

    ChangeMembershipHigh.prototype._type_v2 = function() {
      return constants.sig_types_v2.team.change_membership_high;
    };

    return ChangeMembershipHigh;
  ...
  exports.KBFS = KBFS = (function(_super) {
    __extends(KBFS, _super);

    function KBFS() {
      return KBFS.__super__.constructor.apply(this, arguments);
    }

    KBFS.prototype._type = function() {
      return constants.sig_types.team.kbfs;
    };

    KBFS.prototype._type_v2 = function() {
      return constants.sig_types_v2.team.kbfs;
    };
