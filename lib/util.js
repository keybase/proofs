...
(function() {
  var Lock, bufeq_secure, constants, crypto, get_own, has_own, json_secure_compare, json_stringify_sorted, pack, v2_sig_type_from_sig_type, _has_own, _ref;
  ...
  exports.has_own = has_own = function(o, k) {
    return _has_own.call(o, k);
  };

  exports.get_own = get_own = function(o, k) {
    if (_has_own.call(o, k)) {
      return o[k];
    } else {
      return void 0;
    }
