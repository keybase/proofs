...
(function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/me/code/proofs/src/web_service.iced",
  ...
  BitbucketBinding = (function(_super) {
    ...
    BitbucketBinding.prototype.service_name = function() {
      return "bitbucket";
    };
  ...
  GenericSocialBinding = (function(_super) {
    ...
    GenericSocialBinding.prototype.proof_type = function() {
      return constants.proof_type.generic_social;
    };

    GenericSocialBinding.check_name = function(n) {
      if ((n == null) || ((n = n.toLowerCase()) == null)) {
        return false;
    ...
    GenericSocialBinding.name_hint = function() {
      return "alphanumerics, lower case";
    };

    GenericSocialBinding.prototype.check_name = function(n) {
      return GenericSocialBinding.check_name(n);
    };

    GenericSocialBinding._check_remote_service = function(n) {
      if ((n == null) || ((n = n.toLowerCase()) == null)) {
        return false;
      } else if (n.match(/^[a-z0-9_\-\.]{1,15}\.[a-z0-9]{2,15}$/)) {
        return true;
      } else {
        return false;
      }
