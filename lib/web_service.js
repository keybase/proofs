...
(function() {
  var Base, CoinbaseBinding, DnsBinding, GenericWebSiteBinding, GithubBinding, KeybaseBinding, SocialNetworkBinding, TwitterBinding, WebServiceBinding, cieq, constants, has_non_ascii, iced, urlmod, __iced_k, __iced_k_noop, _ref,
  ...
  CoinbaseBinding = (function(_super) {
    ...
    CoinbaseBinding.check_name = function(n) {
      if ((n == null) || ((n = n.toLowerCase()) == null)) {
        return false;
      } else if (n.match(/^[a-z0-9][a-z0-9-]{0,20}$/)) {
        return true;
      } else {
        return false;
      }
