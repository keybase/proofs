...
(function() {
  var Base, KeybaseBinding, TwitterBinding, WebServiceBinding, bufeq_secure, constants, kbpgp, unix_time, _ref, _ref1, _ref2,
  ...
  WebServiceBinding = (function(_super) {
    ...
    WebServiceBinding.prototype._v_check = function(_arg, cb) {
      ...
      json = _arg.json;
      console.log("checking local _v_Check");
      console.log(json);
      console.log(typeof json);
      console.log(json.body);
      console.log(json.body.key);
      console.log(json.body.key.username);
  ...
  TwitterBinding = (function(_super) {
    ...
    TwitterBinding.prototype._service_obj_check = function(x) {
      var so;
      so = this.service_obj();
      return (x != null) && (so.username === x.username) && (so.name === x.name);
    };

    TwitterBinding.prototype.service_obj = function() {
      return {
        name: "twitter.com",
  ...
  KeybaseBinding = (function(_super) {
    ...
    function KeybaseBinding() {
      _ref2 = KeybaseBinding.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
