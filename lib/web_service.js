...
(function() {
  ...
  GenericWebSiteBinding = (function(_super) {
    ...
    GenericWebSiteBinding.check_input = function(i) {
      if (!i.match(/[a-z0-9]+:\/\//)) {
        i = "https://" + i;
      }
      return GenericWebSiteBinding.parse(i) != null;
    };

    GenericWebSiteBinding.prototype.check_input = function(i) {
      return GenericWebSiteBinding.check_input(i);
    };
