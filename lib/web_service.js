...
(function() {
  var Base, GenericWebSiteBinding, GithubBinding, KeybaseBinding, SocialNetworkBinding, TwitterBinding, WebServiceBinding, cieq, constants, iced, urlmod, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  GenericWebSiteBinding = (function(_super) {
    ...
    GenericWebSiteBinding.parse = function(h) {
      var o, ret;
      ret = null;
      if ((h != null) && ((h = h.toLowerCase()) != null) && ((o = urlmod.parse(h)) != null) && (o.protocol != null) && (o.hostname != null)) {
        ret = {
          protocol: o.protocol,
          hostname: o.hostname
        };
    ...
    GenericWebSiteBinding.prototype._service_obj_check = function(x) {
      var so;
      so = this.service_obj();
      return (x != null) && (so != null) && cieq(so.procotol, x.protocol) && cieq(so.hostname, x.hostname);
    };
    ...
    GenericWebSiteBinding.prototype.name_hint = function() {
  ...
  TwitterBinding = (function(_super) {
    ...
    TwitterBinding.prototype.name_hint = function() {
  ...
  GithubBinding = (function(_super) {
    ...
    GithubBinding.prototype.name_hint = function() {
