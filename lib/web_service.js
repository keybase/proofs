...
(function() {
  var Base, BitbucketBinding, CoinbaseBinding, DnsBinding, FacebookBinding, GenericSocialBinding, GenericWebSiteBinding, GithubBinding, HackerNewsBinding, KeybaseBinding, RedditBinding, SocialNetworkBinding, TwitterBinding, WebServiceBinding, cieq, constants, has_non_ascii, iced, urlmod, __iced_k, __iced_k_noop, _ref,
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/miles/go/src/github.com/keybase/proofs/src/web_service.iced",
  ...
  DnsBinding = (function(_super) {
    ...
    DnsBinding.prototype.service_name = DnsBinding.service_name;
  ...
  TwitterBinding = (function(_super) {
    ...
    TwitterBinding.prototype.service_name = TwitterBinding.service_name;
  ...
  FacebookBinding = (function(_super) {
    ...
    FacebookBinding.prototype.service_name = FacebookBinding.service_name;
  ...
  KeybaseBinding = (function(_super) {
    ...
    KeybaseBinding.prototype.service_name = KeybaseBinding.service_name;
  ...
  GithubBinding = (function(_super) {
    ...
    GithubBinding.prototype.service_name = GithubBinding.service_name;
  ...
  BitbucketBinding = (function(_super) {
    __extends(BitbucketBinding, _super);

    function BitbucketBinding() {
      return BitbucketBinding.__super__.constructor.apply(this, arguments);
    }

    BitbucketBinding.prototype.service_name = BitbucketBinding.service_name;

    BitbucketBinding.service_name = function() {
      return "bitbucket";
    };

    BitbucketBinding.prototype.proof_type = function() {
      return constants.proof_types.bitbucket;
    };

    BitbucketBinding.check_name = function(n) {
      if ((n == null) || ((n = n.toLowerCase()) == null)) {
        return false;
      } else if (n.match(/^[a-zA-Z0-9_\-]{0,31}/)) {
        return true;
      } else {
        return false;
      }
    ...
    BitbucketBinding.name_hint = function() {
      return "alphanumerics, between 1 and 30 characters long";
    };

    BitbucketBinding.prototype.check_name = function(n) {
      return BitbucketBinding.check_name(n);
    };

    return BitbucketBinding;
  ...
  RedditBinding = (function(_super) {
    ...
    RedditBinding.prototype.service_name = RedditBinding.service_name;
  ...
  CoinbaseBinding = (function(_super) {
    ...
    CoinbaseBinding.prototype.service_name = CoinbaseBinding.service_name;
  ...
  HackerNewsBinding = (function(_super) {
    ...
    HackerNewsBinding.prototype.service_name = HackerNewsBinding.service_name;
  ...
  GenericSocialBinding = (function(_super) {
    ...
    GenericSocialBinding.prototype.service_name = GenericSocialBinding.service_name;

    GenericSocialBinding.service_name = function() {
